...
class HIP_Ad_REST_API {
	...
	public function get_config( $request ) {
		...
		$config = array(
			...
			'enableServices'      => isset( $settings['enable_services'] ) ? (bool) $settings['enable_services'] : true,
			'enable_services'     => isset( $settings['enable_services'] ) ? (bool) $settings['enable_services'] : true,
